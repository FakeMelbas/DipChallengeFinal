...
namespace DipChallengeFinal.Controllers
{
    public class PastGamesController : Controller
    {
        ...
        // GET: PastGames/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: PastGames/Create
